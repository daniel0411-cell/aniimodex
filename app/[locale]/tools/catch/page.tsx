...
export default function CatchPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8">
      ...
      <div className="border-l-4 border-emerald-500 bg-emerald-50 px-4 py-3 text-sm leading-6 text-emerald-950"><p className="font-semibold">{t('formulaPendingTitle')}</p><p>{t('formulaPendingDescription')}</p></div>
